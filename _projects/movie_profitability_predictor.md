...
4. 在这个分布上，我们计算了90%置信水平的置信区间，即呈现给用户这个置信水平上的best case和worst case。
 - 推断总体均值：根据中心极限定理我们知道样本均值总是围绕在总体均值周围呈正态分布，因此我们可以根据样本均值来估计总体均值,即为最可能的预测值。
 - 推断标准误差：$$\mathrm{SE}=\frac{s(\text { 样本标准差 })}{\sqrt{500}}$$
 - 选择90%置信水平：我们选择较高的置信水平，同时又希望置信区间不要过于宽泛失去参考价值。
 - 计算置信区间：$$[$ 总体均值 $-$ zscore $*$ 标准误差，总体均值 $+$ zscore $*$ 标准误差 $]$$    90%置信水平对应的z-score为1.64
